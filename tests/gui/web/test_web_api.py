...
class TestWebAPIEndpoints:
    ...
    def test_get_status_idle(self, client, mock_service):
    ...
    def test_get_status_running(self, client, mock_service):
    ...
    def test_start_scraping_today(self, client, mock_service):
    ...
    def test_start_scraping_date_range(self, client, mock_service):
    ...
    def test_start_scraping_validation_error(self, client, mock_service):
    ...
    def test_start_scraping_already_running(self, client, mock_service):
    ...
    def test_pause_job(self, client, mock_service):
    ...
    def test_resume_job(self, client, mock_service):
    ...
    def test_get_logs(self, client, mock_service):
    ...
    def test_get_configuration_options(self, client):
...
class TestWebAPISSE:
    ...
    def test_sse_endpoint_documentation(self):
